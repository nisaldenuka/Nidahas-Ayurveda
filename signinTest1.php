...
{
	$uname=$_POST["txtemail"]; $pw=$_POST["txtpw"];
	if(isset($_POST["txtemail"]) && $_POST["txtpw"])
	{

	$sql="SELECT email,password FROM patienttb WHERE email='$uname' AND password ='$pw'";
...
{
  $uname=$_POST["txtemail"]; $pw=$_POST["txtpw"];$pnum=$_POST["txtnum"];
  if(isset($_POST["txtemail"]) && $_POST["txtpw"] && $pnum!="")
  {

    $duplicate="SELECT id,email,password FROM patienttb WHERE id='$pnum'";
  ...
  if(mysqli_num_rows($result2)>0)
  {
    $row1=mysqli_fetch_array($result2);
      ...
      if($row1['email']==NULL && $row1['password']==NULL){

        $sql="UPDATE patienttb SET email='$uname',password='$pw' WHERE id='$pnum'";
        $result=mysqli_query($con,$sql);
...
body, html{
  ...
  background-image: linear-gradient(to left, #1ab294, transparent);
}
  ...
  <div class="form">
    <div class="sign-in" id="sign-in-info">
      ...
      <form id="sign-in-form" action="#" method="post">      
        ...
        <input type="password" placeholder="Password" name="txtpw"/>
        <!--<p class="forgot-password">Forgot your password?</p>-->
        <button class="control-button in" name="btnlogin">Login</button>
      </form>
    </div>
    <div class="sign-up" id="sign-up-info">
      ...
      <form id="sign-up-form" action="#" method="post">
        <input type="text" placeholder="Patient Identity Number" name="txtnum" minlength="11"/>
        <input type="email" placeholder="Email" name="txtemail" />
        <input type="password" placeholder="Password" name="txtpw" minlength="8" maxlength="100"/>
        <button class="control-button up" name="btnsign">Sign Up</button>
      </form>
    </div>
  </div>
