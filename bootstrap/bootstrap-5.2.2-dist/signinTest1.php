...
if(isset($_POST["btnlogin"]))
{
	...
	//sql query
	$sql="SELECT email,password FROM patient WHERE email='$uname' AND password ='$pw'";
...
if(isset($_POST["btnsign"]))
{
  ...
  //sql query
  //$sql="SELECT username,password FROM tblpatientlogin WHERE username='$uname' AND password ='$pw'";
  $sql="UPDATE patient SET email='$uname',password='$pw' WHERE Pnumber='$pnum'";
  $result=mysqli_query($con,$sql);
  ...
  <div class="form">
    ...
    <div class="sign-up" id="sign-up-info">
      ...
      <form id="sign-up-form" action="#" method="post">
        <input type="text" placeholder="Patient Number" name="txtnum" />
        <input type="email" placeholder="Email" name="txtemail" />
        <input type="password" placeholder="Password" name="txtpw" />
